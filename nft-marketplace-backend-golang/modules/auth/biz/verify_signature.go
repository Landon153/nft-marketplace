...
import (
	...
	"service-nft-marketplace-200lab/component/tokenprovider"
...
func (biz *verifySignatureBiz) VerifySignature(
	...
	result, err := biz.store.FindUserWithCondition(
		ctx, map[string]interface{}{"wallet_address": data.WalletAddress, "nonce": data.Nonce},
	)
	...
	// Generate token
	payload := tokenprovider.TokenPayload{UserId: result.Id}
